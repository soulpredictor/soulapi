...
filetostart = ['telegram_bot', '/home/container/soul/telegram_bot', '/home/container/xtream/telegram_bot']  # Example: ['telegram_bot', 'another_file', 'yet_another_file']
...
if __name__ == '__main__':
    ...
    logger.info("")
    app.run(host='127.0.0.1', port=1590, debug=True)