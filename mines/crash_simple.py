...
try:
    ...
    # urllib3 might not have these specific exceptions in older versions
    NameResolutionError = None
    NewConnectionError = None
...
class StakeCrashBot:
    def __init__(self, bot_token: str = "7750047037:AAHj4luusJNxXxkgLea-CEosLH1smt0aeyc"):
...
"""
    ...
    def _create_crash_scraper(self):
        """Create a fresh cloudscraper instance for crash API requests"""
    ...
    def _fetch_crash_history(self, access_token, limit=20):
        ...
        for attempt in range(max_retries):
            try:
                # Create fresh scraper instance for each attempt (like main.py)
                scraper = self._create_crash_scraper()
